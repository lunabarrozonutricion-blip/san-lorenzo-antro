                  ...
                  >
                    ...
                    <div className="mt-4 grid gap-2 sm:grid-cols-2 lg:grid-cols-5">
                      ...
                      {showObjectives && (
                        <>
                          <MiniStat
                            label={`Objetivo ${objectivePeriodLabel}`}
                            value={
                              summary.target !==
                              null
                                ? `${fmt(
      ...
      {periods.map(
        ([key, label]) => {
          ...
          return (
            <div
              key={key}
              className="grid gap-2 md:grid-cols-[110px_1fr] md:items-center"
            >
