...
export const Route = createFileRoute("/control")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "Nuevo control – Seguimiento Antropométrico CASLA",
      },
      {
        name: "description",
        content:
          "Cargá una medición comparando en vivo con el control anterior.",
      },
      {
        property: "og:title",
        content:
      ...
      },
      {
        ...
        content:
          "Peso, pliegues y perímetros con diferencias calculadas al instante.",
      },
    ],
  }),
